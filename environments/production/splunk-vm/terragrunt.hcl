...
inputs = {
  ...
  # VM configuration - Higher specs for production
  ...
  # Data Disk for Splunk - Larger for production
  create_data_disk  = true
  data_disk_type    = "Premium_LRS"
  data_disk_size_gb = 1024  # 1TB for production logs
